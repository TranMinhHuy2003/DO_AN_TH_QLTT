...
-- BACKUP
BACKUP DATABASE QuanLyGiaoVu TO DISK = 'C:\DoAn\QLGV_DB_BACKUP.BAK'

-- DELETE
DROP DATABASE QuanLyGiaoVu

-- RESTORE
RESTORE DATABASE QuanLyGiaoVu FROM DISK = 'C:\DoAn\QLGV_DB_BACKUP.BAK'
...
SET DATEFORMAT DMY
INSERT INTO GIANGDAY VALUES ('IT004.N21', 'GV05', 1, '2022-2023', '07/12/2022', '08/09/2022') -- THẤT BẠI
INSERT INTO GIANGDAY VALUES ('IT004.N21', 'GV05', 1, '2022-2023', '22/09/2022', '01/12/2022') -- THÀNH CÔNG
SELECT * FROM GIANGDAY
...
-- 3. DIEMTB không được nhỏ hơn 0 hoặc lớn hơn 10
