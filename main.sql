...
-- 2. SINHVIEN KHONG CO QUYEN BANG SV_MH
--TAO LOGIN
USE MASTER
GO
...
GO
-- SINHVIEN BI TU CHOI QUYEN SELECT, INSERT, UPDATE, DELETE TREN BANG SV_MH
DENY SELECT, INSERT, UPDATE, DELETE ON SV_MH TO SV_XEMDIEM
